...
export default function LoyaltyCard() {
  // SSR is disabled (see app/page.tsx) so localStorage is always available here
    ...
    <div className="min-h-screen bg-amber-50 flex flex-col items-center justify-center p-4">
      <div className="fixed top-0 left-0 right-0 z-10 bg-amber-900 text-white">
        <div className="max-w-sm mx-auto px-4 py-2 flex items-center justify-between">
          <button type="button" onClick={handleLogout} className="text-sm text-amber-300 underline">
            Salir
          </button>
      ...
      <div className="w-full max-w-sm space-y-4 pt-10">
        ...
        <button
          ...
          className={`w-full font-bold py-3 rounded-xl transition-colors ${
            notified ? 'bg-green-500 text-white' : 'bg-amber-700 active:bg-amber-900 text-white'
          }`}
        >
